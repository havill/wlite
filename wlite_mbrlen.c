/*
 * $Id: wlite_mbrlen.c,v 1.1 2002/12/10 21:57:58 havill Exp havill $
 *
...
size_t
wlite_mbrlen(const char *s, size_t n, wlite_mbstate_t *ps) {
    static wlite_mbstate_t internal = { 0 };

    return wlite_mbrtowc(0, s, n, ps != NULL ? ps : &internal);
}
